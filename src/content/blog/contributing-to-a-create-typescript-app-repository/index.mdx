...
import elsaPuttingUpHair from "~/assets/blog/the-good-place-come-on-in.webm";
import gastonReadTheBooks from "~/assets/blog/the-good-place-come-on-in.webm";
import kenanThompsonThankYou from "~/assets/blog/the-good-place-come-on-in.webm";
import patrickStarILoveYou from "~/assets/blog/the-good-place-come-on-in.webm";
...
import vsCodeInstallRecommendedExtensions from "~/assets/blog/assholes-everywhere.png";
